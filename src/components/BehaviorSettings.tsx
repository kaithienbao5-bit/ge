    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="bg-[#050505]/40 border border-purple-500/20 rounded-xl p-5 space-y-4 shadow-lg shadow-purple-500/[0.02]">
        <div className="border-b border-purple-500/10 pb-3 flex items-center justify-between">
          ...
          <span className="text-[10px] font-bold bg-purple-500/10 text-purple-400 px-2 py-0.5 rounded border border-purple-500/20 font-mono uppercase">1 - 10</span>
        </div>
                ...
                {config.enableFakeWebsite && (
                  <div className="space-y-4 animate-in fade-in duration-200 pt-3 border-t border-white/5">
                    <div className="space-y-1.5">
                      ...
                      <p className="text-[9.5px] text-white/45 leading-relaxed">
                        Hệ thống sẽ dựng một trang báo tin tức giống hệt thật với đa dạng đoạn văn chi chít chữ và các biểu ngữ quảng cáo xung quanh. Toàn bộ trang báo sẽ bị làm mờ để giữ lại duy nhất đoạn phụ đề trung tâm hiển thị sắc nét. Một con trỏ chuột mô phỏng sẽ trượt mượt xuống, tự động bôi đen hai từ tâm điểm!
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-4 pt-3 border-t border-white/5 animate-in fade-in duration-200">
                    <div className="space-y-1.5">
                      ...
                      <input
                        type="text"
                        id="drawCircleBlocks"
                        placeholder="Ví dụ: 2, 4, 7 hoặc #3"
                    ...
                    <p className="text-[10px] text-white/50 leading-relaxed">
                      Con trỏ chuột mô phỏng sẽ di chuyển tự nhiên đến vị trí phụ đề, thao tác "vẽ" một vạch tròn đỏ khép kín bao quanh, dán tiếp một mũi tên màu đỏ sinh động và tự nhiên!
                    </p>
                  </div>
                )}
              </div>
